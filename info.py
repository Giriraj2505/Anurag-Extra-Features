...
BOT_TOKEN = environ.get('5188353692:AAHum11y3gJIBcXTuviMHLlx7HMrhl6gWpY')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('1892306299',).split()]
